...
logging.basicConfig(level=logging.INFO, filemode="w", filename="tests_all.log", encoding="utf-8",
...
class RunnerTest(unittest.TestCase):
    ...
    def test_walk(self):
        try:
            walker = Runner(name="Андрей", speed=-1)
            walker.walk()
            self.assertEqual(walker.distance, 1)
